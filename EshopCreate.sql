...
FROM
    STORES S
    -- Join PRODUCTS to get products of the store
    INNER JOIN PRODUCTS P ON S.STORE_ID = P.STORE_ID
    -- Join PROD_CAT to get product categories
    INNER JOIN PROD_CAT PRC ON P.PRODUCT_ID = PRC.PRODUCT_ID